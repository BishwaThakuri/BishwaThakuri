...
<p align="center">
    <a href="https://git.io/typing-svg">
        <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&center=true&size=25&pause=1000&width=800&lines=I'm+Bishwa+Thakuri;🚀+Full-Stack+Developer+%7C+AI+%26+ML+Explorer;💡+Passionate+About+Tech+%26+Innovation;🌍+Trying+to+Build+Something+Awesome!" alt="Typing SVG" />
    </a>
</p>
...
# 💫 About Me:
🔭 Currently Working On Enhancing AI/ML models and building innovative web solutions.<br><br>👯 Looking to Collaborate On: AI-driven applications, full-stack projects, and data science solutions.<br><br>🤝 Seeking Help With: Exploring cutting-edge AI research and real-world applications.<br><br>🌱 Currently Learning: Advanced machine learning techniques, cloud computing, and scalable backend architectures.<br><br>💬 Ask Me About AI, ML, full-stack development, and optimizing software for performance and scalability.<br><br>⚡ Fun Fact: I once built a sentiment analysis model to see how my code felt about me! 😆
